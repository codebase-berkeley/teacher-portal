...
class CellResponses extends Component {
  render() {
    return (
      <div>
        <p className="cell-responses">
          What was your favorite part of this unit?
        </p>

        <div className="container">{displayResponses(array)}</div>
      </div>
    );
  }
}

export default CellResponses;
